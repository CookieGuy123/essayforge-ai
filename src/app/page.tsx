  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background via-background/95 to-secondary/30 text-foreground transition-colors">
      ...
      <nav className="h-20 border-b border-border/40 backdrop-blur-xl sticky top-0 z-40 bg-card/60">
        <div className="max-w-6xl mx-auto h-full px-6 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-2xl bg-gradient-to-tr from-orange-500 via-amber-500 to-red-600 flex items-center justify-center text-white shadow-lg shadow-orange-500/25">
              <Flame className="h-6 w-6" />
            </div>
            <span className="font-extrabold text-xl tracking-tight text-orange-600 dark:text-orange-400">
              EssayForge AI
            </span>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Button asChild size="lg" className="shadow-md shadow-orange-500/20 bg-gradient-to-r from-orange-500 via-amber-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-bold rounded-xl">
              <Link href="/lite">
      ...
      <main className="flex-1 max-w-6xl mx-auto px-6 py-16 flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-orange-500/30 bg-orange-500/10 text-orange-600 dark:text-orange-400 text-sm font-semibold mb-8">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight max-w-4xl leading-[1.1] mb-6 text-foreground">
          Forge College Essays That Stay <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-amber-500 to-red-600 dark:from-orange-400 dark:via-amber-400 dark:to-red-500">Uniquely Yours</span>
        </h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
          <Button asChild size="lg" className="h-14 px-8 text-lg font-bold rounded-2xl shadow-xl shadow-orange-500/25 bg-gradient-to-r from-orange-500 via-amber-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white">
            <Link href="/lite">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left w-full mt-6">
          <Card className="p-2 border-border/40">
            <CardContent className="p-6 space-y-3">
              <div className="h-12 w-12 rounded-2xl bg-orange-500/10 border border-orange-500/20 text-orange-500 flex items-center justify-center mb-4">
                <Lock className="h-6 w-6" />
              </div>
              <h3 className="text-xl font-bold">100% Offline Privacy</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Connects directly to your local LM Studio instance at <code className="text-xs bg-muted px-1.5 py-0.5 rounded text-orange-400">http://127.0.0.1:1234</code>. No data is ever sent to cloud servers.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="p-2 border-border/40">
            <CardContent className="p-6 space-y-3">
              <div className="h-12 w-12 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-amber-500 flex items-center justify-center mb-4">
          ...
          <Card className="p-2 border-border/40">
            <CardContent className="p-6 space-y-3">
              <div className="h-12 w-12 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-500 flex items-center justify-center mb-4">
