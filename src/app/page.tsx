...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-background via-background/95 to-secondary/30 text-foreground">
      {/* Top Navbar */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left w-full mt-6">
          ...
          <Card className="p-2 border-border/40">
            <CardContent className="p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Uncover authentic anecdotes and life experiences through our AI Interviewer, then save them into your personal Story Vault.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="p-2 border-border/40">
            <CardContent className="p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Evaluate drafts for authenticity, structure, clarity, and voice. Get line-by-line feedback without losing your authentic writing tone.
              </p>
            </CardContent>
          </Card>
        </div>
